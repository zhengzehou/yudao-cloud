...
CREATE TABLE IM_USER_FRIENDS (
      ...
      MEMO VARCHAR(256) NULL COMMENT '添加时的备注',
      CREATOR              varchar(64)           DEFAULT '' COMMENT '创建人',
      CREATE_TIME          datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '发送时间',
      UPDATER              varchar(64)           DEFAULT '' COMMENT '修改人',
      UPDATE_TIME          datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IM_USER_FRIENDS_APPLY (
         ID BIGINT auto_increment NOT NULL COMMENT 'ID',
         USER_ID BIGINT NOT NULL COMMENT '我的账号ID',
         FRIEND_ID BIGINT NOT NULL COMMENT '好友账号ID',
         STATUS INT DEFAULT 1 NOT NULL COMMENT '当前状态（0通过、1待通过、2拒绝）',
         MEMO VARCHAR(256) NULL COMMENT '申请好友留言',
         ANS_MEMO VARCHAR(256) NULL COMMENT '留言回复',
         CREATOR              varchar(64)           DEFAULT '' COMMENT '创建人',
         CREATE_TIME          datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '发送时间',
         UPDATER              varchar(64)           DEFAULT '' COMMENT '修改人',
         UPDATE_TIME          datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
         DELETED              bit      NOT NULL DEFAULT FALSE COMMENT '删除',
         TENANT_ID             bigint(20)  NOT NULL COMMENT '租户ID',
         CONSTRAINT USER_FRIENDS_APPLY_PK PRIMARY KEY (ID)
) COMMENT='我的好友申请列表';
CREATE INDEX IM_USER_FRIENDS_APPLY_USER_ID_IDX USING BTREE ON IM_USER_FRIENDS_APPLY (USER_ID);
CREATE INDEX IM_USER_FRIENDS_APPLY_FRIEND_ID_IDX USING BTREE ON IM_USER_FRIENDS_APPLY (FRIEND_ID);
CREATE INDEX IM_USER_FRIENDS_APPLY_CREATE_TIME_IDX USING BTREE ON IM_USER_FRIENDS_APPLY (create_time);
