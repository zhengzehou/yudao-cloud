...
CREATE TABLE IF NOT EXISTS `product_spu` (
    ...
    `recommend_hot` bit(1) NOT NULL default 0 COMMENT '是否热卖推荐: 0 默认 1 热卖',
    `recommend_benefit` bit(1) NOT NULL default 0 COMMENT '是否优惠推荐: 0 默认 1 优选',
    `recommend_best` bit(1) NOT NULL default 0 COMMENT '是否精品推荐: 0 默认 1 精品',
    `recommend_new` bit(1) NOT NULL default 0 COMMENT '是否新品推荐: 0 默认 1 新品',
    `recommend_good` bit(1) NOT NULL default 0 COMMENT '是否优品推荐',
...
CREATE TABLE IF NOT EXISTS `product_comment` (
    ...
    `sku_pic_url` varchar(3000) DEFAULT NULL COMMENT '商品 SKU 图片地址',
    `pic_urls` varchar(3000) DEFAULT NULL COMMENT '评论图片地址数组',
    `sku_properties` varchar(3000) DEFAULT NULL COMMENT '属性数组',
...
CREATE TABLE `promotion_bargain_activity` (
      `id` bigint NOT NULL AUTO_INCREMENT COMMENT '编号',
      `name` varchar(256) NOT NULL COMMENT '砍价活动名称',
      ...
      `stock` int NOT NULL default 0 COMMENT '砍价库存(剩余库存砍价时扣减)',
